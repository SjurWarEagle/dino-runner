...
export default class Preloader extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image(
      ...
      'characters/monkey/monkey_run_1.png'
    );
    this.load.image(
      TextureKeys.MonkeyRun2,
      'characters/monkey/monkey_run_2.png'
    );
    this.load.image(
      TextureKeys.MonkeyRun3,
      'characters/monkey/monkey_run_3.png'
    );
    this.load.image(
      TextureKeys.MonkeyRun4,
      'characters/monkey/monkey_run_4.png'
    );
    this.load.image(
      TextureKeys.MonkeyRun5,
      'characters/monkey/monkey_run_5.png'
    );
    this.load.image(
      TextureKeys.MonkeyRun6,
      'characters/monkey/monkey_run_6.png'
    );
    this.load.image(
      TextureKeys.MonkeyRun7,
      'characters/monkey/monkey_run_7.png'
    );
  ...
  create() {
    ...
    this.anims.create({
      key: AnimationKeys.MonkeyRun,
      frames: [
        { key: TextureKeys.MonkeyRun1 },
        { key: TextureKeys.MonkeyRun2 },
        { key: TextureKeys.MonkeyRun3 },
        { key: TextureKeys.MonkeyRun4 },
        { key: TextureKeys.MonkeyRun5 },
        { key: TextureKeys.MonkeyRun6 },
        { key: TextureKeys.MonkeyRun7, duration: 50 },
      ],
      frameRate: 10,
      repeat: -1,
    });
