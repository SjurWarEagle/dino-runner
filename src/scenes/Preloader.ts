...
export default class Preloader extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.atlas(
      ...
      "characters/eagle/eagle.png",
      "characters/eagle/eagle.json"
    );
    this.load.atlas(
      TextureKeys.Bubble,
  ...
  create() {
    this.anims.create({
      ...
      frames: [
        { key: TextureKeys.DinoRun1, frame: 1 },
        { key: TextureKeys.DinoRun2, frame: 2 },
        { key: TextureKeys.DinoRun3, frame: 3 },
        { key: TextureKeys.DinoRun4, frame: 4 },
        { key: TextureKeys.DinoRun5, frame: 5 },
        { key: TextureKeys.DinoRun6, frame: 6 },
        { key: TextureKeys.DinoRun7, frame: 7 },
        { key: TextureKeys.DinoRun8, frame: 8, duration: 50 },
      ],
      frameRate: 10,
      repeat: -1,
    });
    ...
    this.anims.create({
      ...
      // helper to generate frames
      frames: [
        { key: TextureKeys.DinoDead1, frame: 1 },
        { key: TextureKeys.DinoDead2, frame: 2 },
        { key: TextureKeys.DinoDead3, frame: 3 },
        { key: TextureKeys.DinoDead4, frame: 4 },
        { key: TextureKeys.DinoDead5, frame: 5 },
        { key: TextureKeys.DinoDead6, frame: 6 },
        { key: TextureKeys.DinoDead7, frame: 7 },
        { key: TextureKeys.DinoDead8, frame: 8, duration: 50 },
      ],
      frameRate: 10,
      repeat: -1,
    });
    ...
    this.anims.create({
      ...
      // helper to generate frames
      frames: [
        { key: TextureKeys.DinoIdle1, frame: 1 },
        { key: TextureKeys.DinoIdle2, frame: 2 },
        { key: TextureKeys.DinoIdle3, frame: 3 },
        { key: TextureKeys.DinoIdle4, frame: 4 },
        { key: TextureKeys.DinoIdle5, frame: 5 },
        { key: TextureKeys.DinoIdle6, frame: 6 },
        { key: TextureKeys.DinoIdle7, frame: 7 },
        { key: TextureKeys.DinoIdle8, frame: 8 },
        { key: TextureKeys.DinoIdle9, frame: 9, duration: 50 },
      ],
      frameRate: 10,
      repeat: -1,
    });
    ...
    this.anims.create({
      ...
      // helper to generate frames
      frames: [
        { key: TextureKeys.DinoJump1, frame: 1 },
        { key: TextureKeys.DinoJump2, frame: 2 },
        { key: TextureKeys.DinoJump3, frame: 3 },
        { key: TextureKeys.DinoJump4, frame: 4 },
        { key: TextureKeys.DinoJump5, frame: 5 },
        { key: TextureKeys.DinoJump6, frame: 6 },
        { key: TextureKeys.DinoJump7, frame: 7 },
        { key: TextureKeys.DinoJump8, frame: 8 },
        { key: TextureKeys.DinoJump9, frame: 9 },
        { key: TextureKeys.DinoJump10, frame: 10 },
        { key: TextureKeys.DinoJump11, frame: 11 },
        { key: TextureKeys.DinoJump12, frame: 12, duration: 50 },
      ],
      frameRate: 10,
      repeat: 0,
    });
    ...
    this.anims.create({
      ...
      // helper to generate frames
      frames: [
        { key: TextureKeys.DinoJump1, frame: 12 },
        { key: TextureKeys.DinoJump2, frame: 11 },
        { key: TextureKeys.DinoJump3, frame: 10 },
        { key: TextureKeys.DinoJump4, frame: 9 },
        { key: TextureKeys.DinoJump5, frame: 8 },
        { key: TextureKeys.DinoJump6, frame: 7 },
        { key: TextureKeys.DinoJump7, frame: 6 },
        { key: TextureKeys.DinoJump8, frame: 5 },
        { key: TextureKeys.DinoJump9, frame: 4 },
        { key: TextureKeys.DinoJump10, frame: 3 },
        { key: TextureKeys.DinoJump11, frame: 2 },
        { key: TextureKeys.DinoJump12, frame: 1, duration: 50 },
      ],
      frameRate: 10,
      repeat: 0,
    });
