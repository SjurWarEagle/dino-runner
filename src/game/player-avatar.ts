...
export default class PlayerAvatar extends Phaser.GameObjects.Container {
    ...
    constructor(scene: Phaser.Scene, x: number, y: number) {
        ...
        this.player = scene.add.sprite(0, 0, TextureKeys.DinoIdle1)
            // .setOrigin(0.25, 0.25)
            .setOrigin(0.25, 1)
            .setScale(imageScale)
        ...
        this.playerBody.setSize(this.player.width * imageScale*0.65, this.player.height * imageScale);
        this.playerBody.setOffset(-this.player.width * imageScale / 4, this.player.height * -imageScale);
